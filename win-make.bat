...
avr-gcc  -I. -c Applications/Interrupt/interrupt.c -Os -DF_CPU=16000000UL -I. -mmcu=atmega328p  -o Applications/Interrupt/interrupt.o
mv -f Applications/Interrupt/interrupt.o build/all-o
avr-gcc -mmcu=atmega328p   -o build/boot/sextant.elf build/all-o/PS2Keyboard.o build/all-o/Blink.o build/all-o/ST7565.o build/all-o/interrupt.o build/all-o/main.o
